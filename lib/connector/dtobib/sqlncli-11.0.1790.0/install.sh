...
bin_dir="";
lib_dir="";
sup_dir="/opt/connecteurSQL/smartengine/libs/connector/dtobib";
rll_dir="";
doc_dir="";
inc_dir="";
...
function install()
{
    ...
    if [ $verified -eq 0 ] || [ $force -eq 1 ]; then
        ...
        if [ "$lib_dir" == "" ]; then
            lib_dir="/opt/connecteurSQL/smartengine/libs/connector/dtobib/lib"
        fi

        bin_dir="/opt/connecteurSQL/smartengine/libs/connector/dtobib/bin"
