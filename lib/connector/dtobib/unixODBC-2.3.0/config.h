...
/* Install bindir */
#define BIN_PREFIX "/products/edc/lib/connector/dtobib/bin"
...
/* Lib directory */
#define DEFLIB_PATH "/products/edc/lib/connector/dtobib/lib"

/* Using ini cacheing */
#define ENABLE_INI_CACHING /**/

/* Install exec_prefix */
#define EXEC_PREFIX "/products/edc/lib/connector/dtobib"
...
/* Install includedir */
#define INCLUDE_PREFIX "/products/edc/lib/connector/dtobib/include"

/* Lib directory */
#define LIB_PREFIX "/products/edc/lib/connector/dtobib/lib"

/* Define if the OS needs help to load dependent libraries for dlopen(). */
/* #undef LTDL_DLOPEN_DEPLIBS */

/* Define to the system default library search path. */
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/opt/connecteurSQL/lib/connector/dtobib/c/oracle/11G/linux-x86_64:/usr/lib/vmware-tools/lib32/libvmGuestLib.so:/usr/lib/vmware-tools/lib64/libvmGuestLib.so:/usr/lib/vmware-tools/lib32/libvmGuestLibJava.so:/usr/lib/vmware-tools/lib64/libvmGuestLibJava.so:/usr/lib/vmware-tools/lib32/libDeployPkg.so:/usr/lib/vmware-tools/lib64/libDeployPkg.so"
...
/* Install prefix */
#define PREFIX "/products/edc/lib/connector/dtobib"
...
/* System file path */
#define SYSTEM_FILE_PATH "/products/edc/lib/connector/dtobib/etc"
