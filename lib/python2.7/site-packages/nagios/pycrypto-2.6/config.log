...
generated by GNU Autoconf 2.68.  Invocation command line was
  ...
  $ ./configure --prefix=/products/edc/lib/nagios
...
conftest.c:26: error: 'mpz_powm_sec' undeclared (first use in this function)
...
configure:3448: result: /bin/grep
configure:3453: checking for egrep
configure:3515: result: /bin/grep -E
...
configure:3717: gcc -c -g -O2  conftest.c >&5
conftest.c: In function 'main':
conftest.c:67: warning: integer overflow in expression
conftest.c:67: error: size of array 'test_array' is negative
configure:3717: $? = 1
configure: failed program was:
| /* confdefs.h */
...
config.status:790: src/config.h is unchanged
...
ac_cv_have_decl_mpz_powm_sec=no
...
pdfdir='${docdir}'
prefix='/products/edc/lib/nagios'
