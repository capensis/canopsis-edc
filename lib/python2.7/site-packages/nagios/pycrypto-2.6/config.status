...
ac_cs_config="'--prefix=/products/edc/lib/nagios'"
ac_cs_version="\
...
ac_pwd='/products/edc/lib/nagios/pycrypto-2.6'
srcdir='.'
test -n "$AWK" || AWK=awk
...
if $ac_cs_recheck; then
  set X '/bin/sh' './configure'  '--prefix=/products/edc/lib/nagios' $ac_configure_extra_args --no-create --no-recursion
  shift
...
D["PACKAGE_URL"]=" \"\""
D["HAVE_LIBGMP"]=" 1"
D["HAVE_DECL_MPZ_POWM"]=" 1"
D["HAVE_DECL_MPZ_POWM_SEC"]=" 0"
D["STDC_HEADERS"]=" 1"
